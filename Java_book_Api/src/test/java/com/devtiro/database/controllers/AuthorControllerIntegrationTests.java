...
public class AuthorControllerIntegrationTests {
    ...
    @Test
    public void testThatListAuthorsReturnHttps200() throws Exception{
        mockMvc.perform(
    ...
    @Test
    public void testGetAuthorReturrnsHttpsStatus200() throws Exception {
    ...
    @Test
    public void testGetAuthorReturrnsHttpsStatus404NoAuthorExist() throws Exception {
    ...
    @Test
    public void testGetAuthorReturrnsAuthorWhenExists() throws Exception {
        AuthorEntity authorEntity = TestDataUtil.createTestAuthorA();
        authorService.save(authorEntity);
        mockMvc.perform(
                MockMvcRequestBuilders.get("/authors/1")
